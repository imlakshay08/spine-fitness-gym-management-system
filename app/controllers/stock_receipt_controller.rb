class StockReceiptController < ApplicationController
    ...
    def index
        @LastcodeISS=generate_regularization_series('ISS')
         @AddressListed = nil
         @ActivityNames = nil  
         @UserList      = nil
    ...
    def stock_receipt_refresh
        session[:isErrorhandled] = nil
        session[:postedpamams]   = nil
        isFlags = true
        redirect_to  "#{root_url}stock_receipt"
    end
    ...
    def create
        ...
        if isFlags
             redirect_to  "#{root_url}stock_receipt_list"
        else            
            redirect_to  "#{root_url}stock_receipt"
        end 
    ...
    def stock_receipt_params
        ...
        params[:stock_type]         = params[:stock_type].to_s.present? ? params[:stock_type] : 'ISS'
