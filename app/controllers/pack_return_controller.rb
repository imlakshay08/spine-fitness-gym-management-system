class PackReturnController < ApplicationController
    ...
    def index
        @LastcodePCK=generate_regularization_series('PCK')
         @AddressListed = nil
         @ActivityNames = nil  
         @UserList      = nil
    ...
    def stock_receipt_refresh
        ...
        isFlags = true
        redirect_to  "#{root_url}pack_return"
    end
    ...
    def stock_receipt_params
        ...
        params[:stock_type]         = params[:stock_type].to_s.present? ? params[:stock_type] : 'PCK'
