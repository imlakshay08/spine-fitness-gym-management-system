class ImportExaminationController < ApplicationController
    ...
    def create
        ...
        begin
         if params[:file]!=nil && params[:file]!=''    
            $isimport = params[:process_file_data].to_s
                    ...
                    if params[:process_file_data].to_s!=nil && params[:process_file_data].to_s!='' && params[:process_file_data].to_s =='examination'
                      $checkscaleupdate = params[:checkscale_updated]
                      if ImportExamination.import(params[:file])
                          ...
                          isFlags       =  true
                          modulename = "/"
                          description = ": #{params[:process_file_data]}"
       ...
       redirect_to "#{root_url}"+"import_examination"
      end
end
